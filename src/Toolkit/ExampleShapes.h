...
std::vector< double > WFG1_shape( const std::vector< double >& t_p, const std::vector<double>& S  );

//** Given the last transition vector, get the fitness values for WFG2. *****
std::vector< double > WFG2_shape( const std::vector< double >& t_p );
std::vector< double > WFG2_shape( const std::vector< double >& t_p, const std::vector<double>& S );

//** Given the last transition vector, get the fitness values for WFG3. *****
std::vector< double > WFG3_shape( const std::vector< double >& t_p );
std::vector< double > WFG3_shape( const std::vector< double >& t_p, const std::vector<double>& S  );
std::vector< double > WFG3_shape( const std::vector<double >& t_p,
...
std::vector< double > WFG4_shape( const std::vector< double >& t_p, const std::vector<double>& S  );
